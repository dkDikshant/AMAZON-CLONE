...
import co1 from '../../IMAGES/products/laptop/co1.jpg'
import co2 from '../../IMAGES/products/laptop/co2.jpg'
import co3 from '../../IMAGES/products/laptop/co3.jpg'
import ct1 from '../../IMAGES/products/laptop/ct1.jpg'
import ct2 from '../../IMAGES/products/laptop/ct2.jpg'
import ct3 from '../../IMAGES/products/laptop/ct3.jpg'
        ...
        <div>
            ...
            <div className='App'>
                ...
                <div className='TextContainer' style={{ padding: 20 }}>
                    <Typography style={{ fontSize: '24px', fontWeight: 400 }}>Clovia Women's Snug Fit Active Tights in Navy with Reflective Logo in Blue</Typography>
                    <Typography style={{ color: '#0071A5', cursor: 'pointer' }}>Visit the Acer Store</Typography>
                    <Typography style={{ fontWeight: 400, fontSize: '28px' }}>&#x20b9;4,940</Typography>
                    <Box>
                        ...
                        <Box style={{ display: 'flex', paddingTop: 2 }}>
                            ...
                            <Typography style={{ fontWeight: 400, fontSize: '14px' }}>Regular Fit</Typography>
                        </Box>
                        <Box style={{ display: 'flex', paddingTop: 2 }}>
